...
<body style="background-color: #f47407">
	...
	<div class="card-body mt-5">
		...
		<form action="AddContactServlet" method="post">
			<h2 class="text-center mt-3 text-white">Add Contact Page</h2>
			...
			<div class="mb-3">
				...
				<input type="text" name="mobile" class="form-control" id="exampleInputPassword1" placeholder="Enter your password">
			</div>
			...
			<div class="text-center">
				<button type="submit" class="btn  btn-sm " style="background-color: #ffd800">Save
					Contact</button>
			</div>
		</form>
	</div>
